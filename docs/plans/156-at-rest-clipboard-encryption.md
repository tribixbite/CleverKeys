...
| `ui/settings/sections/ClipboardSection.kt` | Toggle + dialogs + migration progress + unrecoverable-state banner. (The "+ `ClipboardSettingsActivity.kt` if it mirrors" caveat is void — that activity was unreachable and was deleted 2026-08-28.) |
