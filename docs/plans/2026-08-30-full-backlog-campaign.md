...
| K (device) | adb verification on both phones | **SAGA COMPLETE 2026-09-02** (`e87c5b97`): ARC-070 no-leak, warm-up 61ms non-issue, #79 non-reproducing, decode e2e PASS, restore verified, fresh verbose v1.6.0 (sha 6894b2cc…) left installed for the soak. **PIXEL OWED** — unreachable all session (ARP no-route); rerun the pixel pass incl. #148 when it reappears |
