...
| 167 | Nav bar meld + pwd manager | **PARTIAL** | `0288419e` (`setAttributes` write-back was missing — re-application was a no-op); residual: `_insets_bottom` staleness (in progress, wave T4) | comment; hold open for residual |
...
| 79 | UI/header flicker on scroll (A17 inset strip) | **OPEN-LOW** | ARC-114; non-reproducing in waves K/K2; related to #167 residual — wave T4 looks | — |
