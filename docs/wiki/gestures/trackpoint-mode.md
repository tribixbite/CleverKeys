...
description: Joystick-style cursor control
category: Gestures
difficulty: advanced
---
...
TrackPoint mode provides continuous joystick-style cursor movement. Long-press the nav key (between spacebar and enter) and move your finger to control the cursor like a laptop TrackPoint.
...
| **Activation** | Long-press the nav key (between spacebar and enter) |
| **Movement** | Move finger in desired direction |

## How It Works

When you long-press the nav key:

1. After the long-press timeout (~600ms), TrackPoint mode activates
2. A haptic pulse indicates activation (if enabled)
...
### Step 1: Find the Nav Key

The nav key is located between the spacebar and enter key on the bottom row. It has arrow subkeys (up, down, left, right).

### Step 2: Long-Press the Nav Key

Touch and hold the nav key. Wait for the haptic pulse indicating TrackPoint activation.
...
## Difference from Spacebar Swipe

| Feature | Spacebar Swipe | TrackPoint |
|---------|---------------|------------|
| **Activation** | Swipe on spacebar | Long-press nav key |
| **Movement** | Horizontal only | Any direction |
| **Speed** | Proportional to swipe | Proportional to distance |
| **Vertical** | No | Yes |
...
Configure in Settings > Accessibility > TrackPoint Activate.

## Settings

| Setting | Location | Description |
|---------|----------|-------------|
| **Long Press Timeout** | Input section | Time to activate TrackPoint |
| **TrackPoint Haptic** | Accessibility section | Enable/disable activation feedback |
