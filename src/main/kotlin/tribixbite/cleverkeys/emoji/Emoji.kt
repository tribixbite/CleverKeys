    ...
    companion object {
        ...
        private fun initNameMap() {
            ...
            val nameToEmoji = mapOf(
                ...
                "droplet" to "💧", "water" to "💧", "ocean" to "🌊", "water wave" to "🌊",

                // Activities & Sports
                "soccer" to "⚽", "baseball" to "⚾", "basketball" to "🏀", "volleyball" to "🏐",
                "football" to "🏈", "rugby" to "🏉", "tennis" to "🎾", "flying disc" to "🥏",
                "bowling" to "🎳", "cricket game" to "🏏", "field hockey" to "🏑", "ice hockey" to "🏒",
                ...
                "ring" to "💍", "gem" to "💎", "glasses" to "👓", "dark sunglasses" to "🕶️",
                ...
                "keyboard" to "⌨️", "computer mouse" to "🖱️", "trackball" to "🖲️", "disk" to "💽",
                ...
                "tonga" to "🇹🇴", "turkey flag" to "🇹🇷", "trinidad tobago" to "🇹🇹", "tuvalu" to "🇹🇻",
                ...
                // ARC-106: emoticons must not reuse a bare emoji name — mapOf keeps the LAST
                // entry per key, so keying an emoticon as "smile" would silently evict 😄.
                // The emoji owns the bare name; the emoticon key stays qualified but CONTAINS
                // the bare name, so searchByName's contains() fallback still surfaces it for
                // the bare query. Pinned by EmojiNameMapDriftTest (source scan).
                "smile emoticon" to ":)", "happy" to ":)", "grin emoticon" to ":D", "big smile" to ":-D",
                "content" to ":]", "smirk emoticon" to ":>", "anime smile" to "^_^", "cute" to "^.^",
                ...
                "wink emoticon" to ";)", "winky" to ";-)", "wink tongue" to ";P", "cheeky wink" to ";D",
                "tongue emoticon" to ":P", "tongue out" to ":-P", "playful" to ":p", "raspberry" to ":-p",
                ...
                "confused emoticon" to ":\\", "uncertain" to ":-\\", "kiss emoticon" to ":*", "smooch" to ":-*",
                "love" to "<3", "heart emoticon" to "<3", "angry emoticon" to ">:(", "evil smile" to ">:)",
                "devious" to ">:D", "cat face emoticon" to ":3", "kitty" to "=3", "worried emoticon" to ":s",
                ...
                "pacman" to ":v", "bird emoticon" to ":V",

                // Text Emoticons - Kaomoji
                "shrug emoticon" to "¯\\_(ツ)_/¯", "idk" to "¯\\_(ツ)_/¯", "whatever" to "¯\\_(ツ)_/¯",
                "table flip" to "(╯°□°)╯︵┻━┻", "flip table" to "(╯°□°)╯︵┻━┻", "rage flip" to "(╯°□°)╯︵┻━┻",
                "unflip table" to "┬─┬ノ(º_ºノ)", "put back table" to "┬─┬ノ(º_ºノ)",
                "angry flip" to "(ノಠ益ಠ)ノ彡┻━┻", "rage emoticon" to "(ノಠ益ಠ)ノ彡┻━┻",
                ...
                "peaceful" to "(◡‿◡✿)", "puppy eyes" to "(ᵔᴥᵔ)", "sunglasses emoticon" to "(⌐■_■)",
                ...
                "love eyes" to "(♡‿♡)", "flower face" to "(◕ω◕✿)", "cat emoticon" to "(=^･ω･^=)",
                ...
                "bear face" to "ʕ•ᴥ•ʔ", "bear emoticon" to "ʕ•ᴥ•ʔ", "omega face" to "(•ω•)",
                "circle eyes" to "(◔‿◔)", "heart eyes emoticon" to "(｡♥‿♥｡)",
                "sparkle magic" to "✧*。ヾ(｡>v<｡)ﾉﾞ*。✧", "big smile face" to "(*^‿^*)",
                "content face" to "(❛ᴗ❛)", "wave emoticon" to "(ノ^_^)ノ", "victory emoticon" to "(๑•̀ㅂ•́)و✧",
                "wizard" to "(∩^o^)⊃━☆ﾟ.*･｡"
            )
