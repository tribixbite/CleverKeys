 ...
 *   adb shell am broadcast -a tribixbite.cleverkeys.SET_DEBUG_MODE --ez debug_enabled true
 *
 * Responsibilities:
...
class DebugLoggingManager(
    ...
    // it's used inside the SDK_INT >= O guard here; on API 24-25 the 3-arg form is used.
