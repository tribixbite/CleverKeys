...
import tribixbite.keyboard2.ui.Theme
...
class ExtraKeysPreference @JvmOverloads constructor(
    ...
    companion object {
        ...
        fun keyDescription(resources: Resources, name: String): String? {
            ...
            var description = if (descriptionId != 0) resources.getString(descriptionId) else null
        ...
        fun formatKeyCombinationGesture(resources: Resources, keyName: String): String {
            return "${resources.getString(R.string.key_descr_gesture)} + ${KeyValue.getKeyByName(keyName).displayString}"
        }
