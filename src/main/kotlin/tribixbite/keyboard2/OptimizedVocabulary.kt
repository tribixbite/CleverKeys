...
import tribixbite.keyboard2.VocabularyCache
import tribixbite.keyboard2.Config // Assuming Config is in this package or imported
...
class OptimizedVocabulary(private val context: Context) {
    ...
    private fun sendDebugLog(message: String) {
        ...
        try {
            val intent = android.content.Intent("tribixbite.keyboard2.DEBUG_LOG")
