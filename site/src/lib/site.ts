export const site = {
  name: 'CleverKeys',
  tagline: 'On-device gesture typing. Open source. Private.',
  description:
    'A fully open-source gesture keyboard for Android. On-device CTC swipe decoding, unlimited clipboard, 208 swipe gestures, 11 languages.',
...
export const features: Feature[] = [
  {
    title: 'On-device swipe engine',
    blurb:
      'CTC encoder + trie-beam decoding on ONNX Runtime with XNNPACK, plus a layout-agnostic geometric decoder. Sub-200 ms on a Pixel 7.',
    glyph: 'brain',
  },
  {
    title: '100% on-device',
...
export const stats = [
  ...
  { label: 'Swipe decode', value: '<200ms' },
